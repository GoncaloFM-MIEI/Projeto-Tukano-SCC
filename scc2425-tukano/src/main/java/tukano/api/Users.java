...
public interface Users {
	 ...
	 */
	Result<String> createUser(User user, boolean hasCache);
	 ...
	 */
	Result<User> getUser(String userId, String pwd, boolean hasCache);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<User> updateUser(String userId, String pwd, User user, boolean hasCache);
	 ...
	 *         BAD_REQUEST otherwise
	 */
	Result<User> deleteUser(String userId, String pwd, boolean hasCache);
	 ...
	 *         BAD_REQUEST - otherwise.
	 */
	Result<List<User>> searchUsers(String pattern, boolean hasCache);
}
